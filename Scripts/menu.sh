...
echo -e "\033[96m|               _     _                             |\033[0m";
echo -e "\033[96m|              | |   (_)_ __  _   ___  _            |\033[0m";
echo -e "\033[96m|              | |   | |  _ \| | | \ \/ /           |\033[0m";
echo -e "\033[96m|              | |___| | | | | |_| |>  <|           |\033[0m";
echo -e "\033[96m|              |_____|_|_| |_|\__,_/_/\_\           |\033[0m";
echo -e "\033[96m|                   By  KrishnaGupta                |\033[0m";
echo -e "\033[96m|                                                   |\033[0m";
echo -e "\033[96m|            🔥GitHub:- Github.com/Guptaji          |\033[0m";
echo -e "\033[96m|              🌐Site:- Guptajiihacker.github.io    |\033[0m";
echo -e "\033[96m|         💖Instagram:- its_vip_krishna_gupta       |\033[0m";
echo -e "\033[96m+===================================================+\033[0m";

echo -e "\e[1m\e[32mWelcome to the Vip-Linux!\e[0m"
declare -a os_list=()
